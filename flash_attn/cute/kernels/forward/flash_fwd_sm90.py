...
from flash_attn.cute.kernels.common import pipeline as pipeline_custom
from flash_attn.cute.kernels.common.pack_gqa import (
    PackGQA,
    pack_gqa_layout,
...
from flash_attn.cute.kernel_compiler import sym_tag
from flash_attn.cute.kernels.forward.flash_fwd import FlashAttentionForwardBase
from flash_attn.cute.utils import AuxData


class FlashAttentionForwardSm90(FlashAttentionForwardBase):
    @dataclass(frozen=True)
    class Params(FlashAttentionForwardBase.Params):
        intra_wg_overlap: bool = sym_tag("wg_overlap", default=True)
        mma_pv_is_rs: bool = sym_tag("pv_rs", default=True)
        paged_kv_non_tma: bool = sym_tag("paged_non_tma", default=False)

    def __init__(self, params: "FlashAttentionForwardSm90.Params"):
        super().__init__(params)
        self.intra_wg_overlap = params.intra_wg_overlap
        self.mma_pv_is_rs = params.mma_pv_is_rs
