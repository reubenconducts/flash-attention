...
class BlockSparseTensors(NamedTuple):
    """The device-side view of the block-sparse structure: what the kernels
    receive. The host-side model (torch tensors, normalization, conversion)
    is ``flash_attn.cute.block_sparsity.BlockSparseTensorsTorch``."""
